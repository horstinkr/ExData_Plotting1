plot3 <- function() {
	...
	legend("topright", pch="", lwd=2, cex=.9, col=c("black", "red", "blue"), legend=c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"))
